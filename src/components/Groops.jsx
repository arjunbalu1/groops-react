        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p style={{ color: 'rgb(156, 163, 175)' }}>
              {userLocation ? 
                (radius ? `Discover and join groops within ${radius}km of ${isUsingPreciseLocation ? 'your current location' : userLocation.address}` : 'Discover and join all groops worldwide') :
            ...
            <div className="mb-4">
              ...
              <p style={{ color: 'rgb(156, 163, 175)' }}>
                {searchQuery || selectedActivityType || selectedSkillLevel 
                  ...
                  : userLocation 
                    ? (radius ? `No groops found within ${radius}km of ${isUsingPreciseLocation ? 'your current location' : userLocation.address}` : 'No groops found worldwide')
